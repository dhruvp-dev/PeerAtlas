...
export default function AboutPage() {
  return (
    <div className="mx-auto w-full max-w-2xl px-5 pt-12 pb-8 md:pt-16 md:pb-10 animate-fade-up font-sans">
      {/* Page Header */}
      <div>
      ...
      <div className="mt-14 border-t border-border pt-8">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div>
            ...
            >
              Report Issue on GitHub <span className="ml-0.5 transition-transform group-hover:translate-x-0.5 font-bold">→</span>
            </GitHubLink>
          </div>
          ...
          <div>
            ...
            <a
              ...
              className="mt-2 inline-flex items-center text-xs font-semibold text-sky-blue hover:text-navy-deep transition-colors group"
            >
              Contribute Papers <span className="ml-0.5 transition-transform group-hover:translate-x-0.5 font-bold">→</span>
            </a>
          </div>
          ...
          <div>
            ...
            <a
              ...
              className="mt-2 inline-flex items-center text-xs font-semibold text-sky-blue hover:text-navy-deep transition-colors group"
            >
              Email Me Directly <span className="ml-0.5 transition-transform group-hover:translate-x-0.5 font-bold">→</span>
            </a>
          </div>
        </div>
      </div>
